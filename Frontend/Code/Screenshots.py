...
# Function to fetch screenshots from the device and save them in a folder
def fetch_and_save_screenshots(output_folder):
    try:
        # Run the adb command to pull the entire directory to the output folder
        adb_command = f'adb pull /sdcard/Pictures/Screenshots "{output_folder}"'
        ...
        if stderr:
            ...
            print("Screenshots have been saved to:", output_folder)
    except Exception as e:
    ...
    try:
        ...
        if output_folder is not None:  # Check if output_folder is not None before proceeding
            if output_folder:
                ...
                # Fetch and save screenshots into the output folder
                fetch_and_save_screenshots(output_folder)
            else:
